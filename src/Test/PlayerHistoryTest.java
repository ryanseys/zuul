...
public class PlayerHistoryTest {
	...
	public void testAddNullStep() {
		/*most functions associated with addStep are
		implicitly tested by other unit tests
		the only one that we need to check is what if 
		we try to add a null command */
