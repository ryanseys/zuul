...
public class MonsterBuilder extends JPanel implements ActionListener {
	...
	private JButton b0, b1, b2, b3, b4, b5, b6, b7, b8, b10, b11, b12, b13,
			b14, b15;
	private JButton done;
	private Room r0, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13,
			r14, r15;
	private JPanel b9;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == b0) {
			...
			if (popup == 0 || popup == 1) {
				...
				b0.setEnabled(false);
				b0.setText("" + getRooms()[0].getMonster().getName()
						+ " Placed!");
			}
			...
			if (popup == 0 || popup == 1) {
				...
				b1.setEnabled(false);
				b1.setText("" + getRooms()[1].getMonster().getName()
						+ " Placed!");
			}
			...
			if (popup == 0 || popup == 1) {
				...
				b2.setEnabled(false);
				b2.setText("" + getRooms()[2].getMonster().getName()
						+ " Placed!");
			}
			...
			if (popup == 0 || popup == 1) {
				...
				b3.setEnabled(false);
				b3.setText("" + getRooms()[3].getMonster().getName()
						+ " Placed!");
			}
			...
			if (popup == 0 || popup == 1) {
				...
				b4.setEnabled(false);
				b4.setText("" + getRooms()[4].getMonster().getName()
						+ " Placed!");
			}
			...
			if (popup == 0 || popup == 1) {
				...
				b5.setEnabled(false);
				b5.setText("" + getRooms()[5].getMonster().getName()
						+ " Placed!");
			}
			...
			if (popup == 0 || popup == 1) {
				...
				b6.setEnabled(false);
				b6.setText("" + getRooms()[6].getMonster().getName()
						+ " Placed!");
			}
			...
			if (popup == 0 || popup == 1) {
				...
				b7.setEnabled(false);
				b7.setText("" + getRooms()[7].getMonster().getName()
						+ " Placed!");
			}
			...
			if (popup == 0 || popup == 1) {
				...
				b8.setEnabled(false);
				b8.setText("" + getRooms()[8].getMonster().getName()
						+ " Placed!");
			}
			...
			if (popup == 0 || popup == 1) {
				...
				b10.setEnabled(false);
				b10.setText("" + getRooms()[10].getMonster().getName()
						+ " Placed!");
			}
			...
			if (popup == 0 || popup == 1) {
				...
				b11.setEnabled(false);
				b11.setText("" + getRooms()[11].getMonster().getName()
						+ " Placed!");
			}
			...
			if (popup == 0 || popup == 1) {
				...
				b12.setEnabled(false);
				b12.setText("" + getRooms()[12].getMonster().getName()
						+ " Placed!");
			}
			...
			if (popup == 0 || popup == 1) {
				...
				b13.setEnabled(false);
				b13.setText("" + getRooms()[13].getMonster().getName()
						+ " Placed!");
			}
			...
			if (popup == 0 || popup == 1) {
				...
				b14.setEnabled(false);
				b14.setText("" + getRooms()[14].getMonster().getName()
						+ " Placed!");
			}
			...
			if (popup == 0 || popup == 1) {
				...
				b15.setEnabled(false);
				b15.setText("" + getRooms()[15].getMonster().getName()
						+ " Placed!");
			}
